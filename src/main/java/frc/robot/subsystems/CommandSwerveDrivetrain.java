...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    /**
     * Returns a command that resets the robot's pose to the specified pose.
     * Use this at the start of autonomous to define where the robot is.
     * * @param pose The pose to set the robot to
     * @return A command that sets the pose once
     */
    ...
    public Command findPathToPose(Pose2d pose) {
        return Commands.defer(() -> AutoBuilder.pathfindToPose(pose, m_pathConstraints), Set.of(this));
    }

    public Command findPathToPose(Pose2d pose, double goalEndVelocity) {
        return Commands.defer(
            () -> AutoBuilder.pathfindToPose(pose, m_pathConstraints, goalEndVelocity),
            Set.of(this)
        );
    }
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("Odometry rotation", currentPose.getRotation().getDegrees());
    }
