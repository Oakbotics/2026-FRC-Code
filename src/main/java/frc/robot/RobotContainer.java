...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        // joystick.a().whileTrue(new InstantCommand(() -> m_hopperSubsystem.runHopperFront(6))).onFalse(new InstantCommand(() -> m_hopperSubsystem.runHopperFront(0)));
        // joystick.y().whileTrue(new InstantCommand(() -> m_hopperSubsystem.runHopperBack(6))).onFalse(new InstantCommand(() -> m_hopperSubsystem.runHopperBack(0)));
