...
public class WristConstants {
    public static final int wristMotorCANId = 7;//Temp
    public static final int wristEncoderCANId = 37;//SIX SEVEN(temp)
    ...
    public static final double kV = 0.5; // TODO: tune feedforward V
